...
class ControllerExtensionModulePopups extends Controller {
    ...
    public function index() {
        ...
        $data['items'] = $this->model_extension_module_popups->getAll();
        ...
        $data['cities'] = $this->model_extension_module_popups->getCities();
        ...
        $data['l_city'] = $this->language->get('city');
    ...
    public function edit()
    {
        if(!empty($this->request->get['id']))
        {
            ...
            $data['heading_title'] = $this->language->get('heading_edit_title') . '<b>' . $data['item']['title'] . '</b>';
